...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-05-2024 a las 02:09:30
...
INSERT INTO `usuario` (`id_usuario`, `id_rol`, `nombre`, `apellido`) VALUES
(4, 2, 'Juan', 'Lopez'),
(5, 2, 'Monica', 'Gutierrez');
...
--
ALTER TABLE `transacciones`
  MODIFY `id_transaccion` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
